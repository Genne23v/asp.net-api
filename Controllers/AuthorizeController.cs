...
namespace ExploreCalifornia.Controllers
{
    public class AuthorizeController : ApiController
    {
        ...
        {
            return _db.AuthorizedApps.Select(i => new AppDto
            {
                Name = i.Name,
        ...
        public IHttpActionResult Post(AuthorizeRequestDto request)
        {
            ...
            var authApp = _db.AuthorizedApps.FirstOrDefault(i => i.AppToken == request.AppToken && i.AppSecret == request.AppSecret && DateTime.UtcNow < i.TokenExpiration);
